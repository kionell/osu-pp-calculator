...
var md5 = require('md5');
var fs = require('fs');
var osuDownloader = require('osu-downloader');
var osuParsers = require('osu-parsers');
var osuClasses = require('osu-classes');
var osuCatchStable = require('osu-catch-stable');
var osuStandardStable = require('osu-standard-stable');
var osuTaikoStable = require('osu-taiko-stable');
var osuManiaStable = require('osu-mania-stable');
...
function getTotalHits(beatmap) {
    ...
    switch (beatmap.mode) {
        ...
        case exports.GameMode.Fruits: {
            ...
            const tinyDroplets = countNested(osuCatchStable.JuiceTinyDroplet, beatmap);
            const droplets = countNested(osuCatchStable.JuiceDroplet, beatmap) - tinyDroplets;
            const fruits = countNested(osuCatchStable.JuiceFruit, beatmap) + hittable;
