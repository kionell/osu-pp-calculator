...
function formatDownloadStatus(status) {
  switch (status) {
    case osuDownloader.DownloadStatus.FailedToDownload:
      return 'Not Found';
    case osuDownloader.DownloadStatus.FailedToRead:
      return 'Failed To Read';
    case osuDownloader.DownloadStatus.FailedToWrite:
      return 'Failed To Write';
    case osuDownloader.DownloadStatus.FileExists:
      return 'Already Exists';
    case osuDownloader.DownloadStatus.Downloaded:
      return 'Downloaded Successfuly';
    case osuDownloader.DownloadStatus.Written:
...
exports.formatDownloadStatus = formatDownloadStatus;
